...
const useCases: Record<string, UseCasePageContent> = {
  'lead-generation': build({
    ...
    relatedIntegrations: [
      { href: '/integrations/linkedin', label: 'LinkedIn', description: 'Prospect research' },
      { href: '/integrations/hubspot', label: 'HubSpot', description: 'CRM logging' },
      { href: '/integrations/gmail', label: 'Gmail', description: 'Outreach drafts' },
    ],
    demoId: 'sales',
  }),
  'sales-research': build({
    ...
    relatedIntegrations: [
      { href: '/integrations/linkedin', label: 'LinkedIn' },
      { href: '/integrations/hubspot', label: 'HubSpot' },
      { href: '/integrations/notion', label: 'Notion' },
    ],
    demoId: 'sales',
  }),
  'crm-updates': build({
  ...
  'writes-code': build({
    ...
    relatedIntegrations: [
      ...
      { href: '/integrations/linear', label: 'Linear' },
      { href: '/integrations/slack', label: 'Slack' },
    ],
    demoId: 'coding',
  }),
  'uses-browser': build({
    ...
    relatedIntegrations: [
      { href: '/integrations/googlesheets', label: 'Google Sheets' },
      { href: '/integrations/notion', label: 'Notion' },
      { href: '/integrations/slack', label: 'Slack' },
    ],
    demoId: 'launch',
