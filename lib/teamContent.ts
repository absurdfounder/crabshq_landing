    ...
    featureSections: [
      {
        ...
        intro:
          'Run Claude Code, Codex, and OpenCode side-by-side on one ticket — parser patch, ETL dedupe, and regression tests with live tool traces and diff stats.',
      ...
      },
      {
        ...
        intro:
          'Open the ticket Canvas for parser.ts, etl/dedupe.ts, integration CI output, and PR #418 body — the same artifacts from the live demo, stacked for review.',
        visual: 'coding-board',
      },
      {
        eyebrow: 'Memory',
        ...
        intro:
          'AGENTS.md, eslint rules, CODEOWNERS, and merge gates load on every coding mission — Codex, Claude Code, and OpenCode share the same org memory.',
    ...
    featureSections: [
      {
        ...
        intro:
          'Ren ships the pillar page and carousel on Claude Code and Codex while Aria runs competitor SEO — live tool traces on one Q2 ticket.',
      ...
      },
      {
        ...
        intro:
          'Open the campaign Canvas for q2-campaign-brief.md, northstar.io/q2 preview, LinkedIn carousel, and email-sequence.md — the same pack from the live demo.',
      ...
      },
      {
        ...
        intro:
          'brand-voice.md, icp.md, competitor-notes.md, and style-guide.yml load on every marketing mission — Ren, Aria, and Jordan share the same org memory.',
  ...
  sales: buildTeamPage({
    ...
    featureSections: [
      ...
      },
      {
        eyebrow: 'Debrief',
        eyebrowNumber: '05',
        ask: 'trooper, debrief the Acme call to Slack and CRM',
        reply: 'summary + next steps posted',
        window: 'Debrief — Slack',
    ...
    featureSections: [
      {
        eyebrow: 'Governance',
        eyebrowNumber: '03',
        ask: 'trooper, prep the NDA redline — hold for counsel',
      ...
      },
      {
        eyebrow: 'Compliance',
        eyebrowNumber: '04',
        ask: 'trooper, run the weekly policy patrol',
        reply: 'following the compliance runbook',
        window: 'Runbook — Compliance',
  ...
  engineering: buildTeamPage({
    ...
    featureSections: [
      ...
      },
      {
        eyebrow: 'Diffs',
        eyebrowNumber: '05',
        ask: 'trooper, show diffs and CI on Canvas',
        reply: 'patches + green build ready',
    ...
    featureSections: [
      {
        ...
        reply: 'following the SOP — logging each step',
        window: 'Runbook — Ops',
      ...
      },
      {
        eyebrow: 'Alerts',
        eyebrowNumber: '04',
        ask: 'trooper, flag SOP drift to #ops',
        reply: 'alert posted with tool traces',
        window: 'Alerts — Slack',
      ...
      },
      {
        eyebrow: 'Reports',
        eyebrowNumber: '05',
        ask: 'trooper, compile the budget summary for approval',
        reply: 'packet ready — held for ops lead',
        window: 'Reports — Delivery',
    ...
    featureSections: [
      {
        ...
        eyebrowNumber: '03',
        tag: 'BRAND OPS',
        ask: 'trooper, export the Figma frames for brand review',
      ...
      },
      {
        eyebrow: 'Campaign',
        eyebrowNumber: '04',
        ask: 'trooper, attach launch creatives to the ticket',
        reply: 'carousel + landing preview ready',
        window: 'Campaign — Creative',
      ...
      },
      {
        ...
        reply: 'SERP + page snapshots cited',
        window: 'Recon — Brand patrol',
  ...
  'customer-support': buildTeamPage({
    ...
    featureSections: [
      ...
      },
      {
        eyebrow: 'Escalation',
        eyebrowNumber: '04',
        ask: 'trooper, escalate this edge case to humans',
        reply: 'flagged to Slack with full thread',
        window: 'Escalation — Slack',
      ...
      },
      {
        ...
        reply: 'parsed — KB lookup + draft held',
        window: 'Inbox — Support',
  ...
  finance: buildTeamPage({
    ...
    featureSections: [
      ...
      },
      {
        ...
        eyebrowNumber: '04',
        tag: 'RECONCILIATION',
        ask: 'trooper, show the vendor vs ledger diffs',
        reply: 'exceptions highlighted for FP&A',
        window: 'Recon — Side-by-side',
      ...
      },
      {
        eyebrow: 'Governance',
        eyebrowNumber: '05',
        ask: 'trooper, hold the journal entries for controller',
        reply: 'queued — nothing posts yet',
        window: 'Approval — Controller',
    ...
    featureSections: [
      {
        ...
        reply: 'briefs + emails ready for review',
        window: 'Pipeline — BD',
      ...
      },
      {
        eyebrow: 'CRM',
        eyebrowNumber: '04',
        ask: 'trooper, sync partner stages to HubSpot',
        reply: 'pipeline updated — stale deals flagged',
        window: 'CRM — Partnerships',
      ...
      },
      {
        eyebrow: 'Outreach',
        eyebrowNumber: '05',
        ask: 'trooper, hold the partner intro until I approve',
        reply: 'queued with full brief context',
        window: 'Outreach — Approval',
  ...
  research: buildTeamPage({
    ...
    featureSections: [
      ...
      },
      {
        eyebrow: 'Brief',
        eyebrowNumber: '05',
        ask: 'trooper, synthesize an exec brief for GTM',
        reply: 'draft held for strategy lead',
        window: 'Brief — Exec synth',
  ...
  security: buildTeamPage({
    ...
    featureSections: [
      ...
      },
      {
        ...
        reply: 'logs + rollback on the ticket',
        window: 'Incident — SecOps',
      ...
      },
      {
        eyebrow: 'Remediation',
        eyebrowNumber: '05',
        ask: 'trooper, run the IAM rotation checklist',
        reply: 'following the remediations runbook',
        window: 'Runbook — Remediation',
  ...
  pr: buildTeamPage({
    ...
    featureSections: [
      ...
      },
      {
        eyebrow: 'Assets',
        eyebrowNumber: '04',
        ask: 'trooper, attach the press kit to the launch ticket',
        reply: 'creative + landing on one mission',
        window: 'Assets — Launch',
  ...
  growth: buildTeamPage({
    ...
    featureSections: [
      ...
      },
      {
        eyebrow: 'SERP',
        eyebrowNumber: '04',
        ask: 'trooper, capture competitor landing variants',
        reply: 'SERP snapshots on the ticket',
        window: 'SERP — Landing recon',
      ...
      },
      {
        eyebrow: 'Rollout',
        eyebrowNumber: '05',
        ask: 'trooper, prep the winning variant for 100% rollout',
        reply: 'checklist ready — awaiting growth lead',
        window: 'Rollout — Variant',
