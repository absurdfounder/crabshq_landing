      ...
      <div className="rounded-2xl border border-slate-200/80 bg-[#f6f7f8] px-6 py-14 text-center sm:px-10 sm:py-16">
        ...
        <div className="mt-8 flex justify-center">
          <Link
            ...
            className="inline-flex h-11 items-center rounded-lg bg-ink px-5 text-sm font-medium text-white transition-transform duration-200 hover:scale-[1.02] active:scale-[0.98]"
          >
            Explore agents
          </Link>
        </div>
