...
const plans = [
  {
    ...
    badge: null,
    features: [
      'Dedicated 4GB VPS server (managed by us)',
      'Unlimited AI agents',
      'Full desktop built-in',
      'Unlimited browser use',
    ...
    cta: { text: 'Get started free', href: 'https://app.crabshq.com' },
    highlight: false,
  },
  {
    ...
    features: [
      ...
      'Dedicated 4GB VPS server (your control)',
      'Unlimited AI agents',
      'Full desktop built-in',
      'Unlimited browser use',
      'Install your own apps',
