...
export const featureNavItems: NavItem[] = [
  ...
  { href: '/plugin', title: 'Plugin Integrations', description: 'HubSpot, GitHub, Slack & 1,000+ plugins', icon: Zap, iconColor: 'text-emerald-500', bgColor: 'bg-emerald-50' },
...
export const primaryNavLinks = [
  { href: '/plugin', label: 'Integrations' },
