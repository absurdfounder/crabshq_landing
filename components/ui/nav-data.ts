...
export const featureNavItems: NavItem[] = [
  { href: '/characters', title: 'Character Builder', description: 'Design animated agent characters with eyes & motion', icon: Palette, iconColor: 'text-rose-500', bgColor: 'bg-rose-50' },
