          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            >
              ...
              <div className="grid gap-4 mb-8 md:mb-0">
                <Link href="#"
                  className={`flex items-center text-base sm:text-lg p-4 sm:p-5 rounded-md border transition duration-300 ease-in-out border border-dashed shadow-md border-slate-600 hover:shadow-lg text-slate-900 ${tab !== 1 ? "bg-slate-100" : "bg-emerald-800 text-white"
                    }`}
                ...
                <Link href="#"
                  className={`flex items-center text-base sm:text-lg p-4 sm:p-5 rounded-md border transition duration-300 ease-in-out border border-dashed shadow-md border-slate-600 hover:shadow-lg text-slate-900 ${tab !== 2 ? "bg-slate-100" : "bg-emerald-800 text-white"
                    }`}
                ...
                <Link href="#"
                  className={`flex items-center text-base sm:text-lg p-4 sm:p-5 rounded-md border transition duration-300 ease-in-out border border-dashed shadow-md border-slate-600 hover:shadow-lg text-slate-900 ${tab !== 3 ? "bg-slate-100" : "bg-emerald-800 text-white"
                    }`}
                ...
                <Link href="#"
                  className={`flex items-center text-base sm:text-lg p-4 sm:p-5 rounded-md border transition duration-300 ease-in-out border border-dashed shadow-md border-slate-600 hover:shadow-lg text-slate-900 ${tab !== 4 ? "bg-slate-100" : "bg-emerald-800 text-white"
                    }`}
