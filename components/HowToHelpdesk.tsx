...
export default function HowtoHelpdesk() {
  return (
          ...
          <section className=" w-full rounded-2xl py-8 sm:py-12 px-1 sm:px-2 mt-12 mb-12">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="font-funneldisplay text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 text-black">
                We built the first helpdesk
                <span className=" block font-normal text-emerald-600 mt-2">
                  that writes itself from support chats.
                </span>
              </h2>
              <p className="text-lg sm:text-xl text-slate-600">
                Trooper automatically keeps your help center up to date by listening to your team communicate about your product. Here's how it works…
              </p>
            </div>
            ...
            <div className="container mx-auto">
              <div className="flex flex-col items-start space-y-6 lg:space-y-8 xl:space-y-10">
                ...
                <div className="bg-white rounded-3xl xl:sticky xl:top-20 border h-[600px] overflow-hidden w-full">
                  <div className="grid md:flex items-center h-full bg-white">
                    <div className="p-6 sm:p-8 lg:p-10 md:w-2/5 w-full">
                      <p className="text-sm font-bold uppercase tracking-wide text-emerald-600 font-silkscreen">Step #1</p>
                      <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight text-slate-900 mt-2 sm:mt-4">
                        Your content <span className="font-serif font-normal text-emerald-600">lives inside Notion</span>
                      </h3>
                      <p className="text-sm sm:text-base text-slate-700 mt-4">
                        Your work stays in a place you control and love, while Trooper handles the technical parts of publishing it to your website. This means you can focus on what's actually important to you: creating content and building your brand without worrying about configurations, plugins, downtime, performance, or security.
                      </p>
                    </div>
                ...
                <div className="bg-white rounded-3xl xl:sticky xl:top-20 border h-[600px] overflow-hidden w-full">
                  <div className="grid md:flex items-center h-full bg-white">
                    <div className="p-6 sm:p-8 lg:p-10 md:w-2/5 w-full">
                      <p className="text-sm font-bold uppercase tracking-wide text-emerald-600 font-silkscreen">Step #2</p>
                      <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight text-slate-900 mt-2 sm:mt-4">
                        Perfected for <span className="font-serif font-normal text-emerald-600">SEO</span>
                      </h3>
                      <p className="text-sm sm:text-base text-slate-700 mt-4">
                ...
                <div className="bg-white rounded-3xl xl:sticky xl:top-20 border h-[600px] overflow-hidden w-full">
                  <div className="grid md:flex items-center h-full bg-white">
                    <div className="p-6 sm:p-8 lg:p-10 md:w-2/5 w-full">
                      <p className="text-sm font-bold uppercase tracking-wide text-emerald-600 font-silkscreen">Step #3</p>
                      <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight text-slate-900 mt-2 sm:mt-4">
                ...
                <div className="bg-white rounded-3xl xl:sticky xl:top-20 border h-[600px] overflow-hidden w-full">
                  <div className="grid md:flex items-center h-full bg-white">
                    <div className="p-6 sm:p-8 lg:p-10 md:w-2/5 w-full">
                      <p className="text-sm font-bold uppercase tracking-wide text-emerald-600 font-silkscreen">Step #4</p>
                      <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight text-slate-900 mt-2 sm:mt-4">
                ...
                <div className="bg-white rounded-3xl xl:sticky xl:top-20 border h-[600px] overflow-hidden w-full">
                  <div className="grid md:flex items-center h-full bg-white">
                    <div className="p-6 sm:p-8 lg:p-10 md:w-2/5 w-full">
                      <p className="text-sm font-bold uppercase tracking-wide text-emerald-600 font-silkscreen">Step #5</p>
                      <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight text-slate-900 mt-2 sm:mt-4">
                        Create AI Agents <span className="font-serif font-normal text-emerald-600">over your content.</span>
                      </h3>
                      <p className="text-sm sm:text-base text-slate-700 mt-4">
                ...
                <div className="bg-white rounded-3xl xl:sticky xl:top-20 border h-[600px] overflow-hidden w-full">
                  <div className="grid md:flex items-center h-full bg-white">
                    <div className="p-6 sm:p-8 lg:p-10 md:w-2/5 w-full">
                      <p className="text-sm font-bold uppercase tracking-wide text-emerald-600 font-silkscreen">Step #6</p>
                      <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight text-slate-900 mt-2 sm:mt-4">
                        Integrates with <span className="font-serif font-normal text-emerald-600">your existing apps</span>
                      </h3>
                      <p className="text-sm sm:text-base text-slate-700 mt-4">
                        Trooper integrates with the tools you already use. Connect to Slack for notifications, embed your live chat widget from Intercom, Hubspot, Crisp and more. Need your app connected to Trooper? We got you covered.
                      </p>
                    </div>
                    <div className="w-full px-4 pt-6 md:w-3/5 rounded-md mr-4"
                      style={{
          ...
          <section className=" w-full bg-slate-900 rounded-2xl py-8 sm:py-12 px-4 sm:px-6 mt-12 mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-xl mx-auto px-4">
              <Link
                ...
                className="w-full sm:w-auto px-6 py-3 text-lg sm:text-xl bg-emerald-700 text-black rounded-lg hover:bg-emerald-700 transition-colors duration-300 text-center"
              >
                Start from 98% Ready
              </Link>
              <Link
