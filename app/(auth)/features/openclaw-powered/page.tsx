...
export default function OpenClawPoweredPage() {
    return (
        <div>
            <section
                style={{
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl">
                        <h2 className="font-funneldisplay text-2xl sm:text-3xl font-bold text-slate-900 mb-6">
                            The OpenClaw ecosystem, managed for your team
                        </h2>
                    ...
                    <div className="mt-12 grid md:grid-cols-3 gap-8">
                        <div className="p-6 rounded-lg border border-neutral-200">
                            <h3 className="font-semibold text-slate-900 mb-2">Dedicated Private Server</h3>
                            <p className="text-sm text-slate-600">Every organization runs on its own OpenClaw server. Your data, processes, and AI employee memory are completely isolated and secure.</p>
                        </div>
                        <div className="p-6 rounded-lg border border-neutral-200">
                        ...
                        <div className="p-6 rounded-lg border border-neutral-200">
                            ...
                            <p className="text-sm text-slate-600">Get untampered access to the complete OpenClaw ecosystem including ClawHub skills, persistent memory, and multi-agent capabilities through a polished UI.</p>
                        </div>
                    </div>
                </div>
            </section>
