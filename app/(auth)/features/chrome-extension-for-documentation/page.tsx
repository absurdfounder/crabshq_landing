...
export const metadata = {
    ...
    alternates: {
        canonical: "https://crabshq.com/features/chrome-extension-for-documentation",
    },
    openGraph: {
        images: [
            {
                                ...
                                <div className="max-w-screen-xl px-4 mx-auto sm:px-6 mb-4">
                                    <div className="text-center px-4 sm:px-6 lg:px-8">
                                        <h1 className="font-funneldisplay text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-slate-900 leading-tighter tracking-tighter mb-4 aos-init aos-animate">
                                            ...
                                            <br className="block" />
                                            <span className="text-3xl sm:text-4xl md:text-5xl gradient-text-accent mx-4">any tab</span>
                                        </h1>
                                        <p className="max-w-md mx-auto mt-3 text-base text-slate-500 sm:mb-0 sm:text-lg md:mt-5 md:text-lg md:max-w-2xl">
                                            Capture screenshots and update your documentation without leaving your browser. Wonder's Chrome extension makes it easy to keep your docs current from anywhere.
                                        </p>
