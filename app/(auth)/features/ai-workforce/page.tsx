...
export const metadata = {
    title: "AI Workforce - Deploy Multiple AI Employees as a Team | Trooper",
    description:
        "Build AI workforce teams with Trooper. Deploy multiple AI employees that collaborate, share context, and execute tasks autonomously across your entire tech stack.",
    alternates: {
        canonical: "https://trooper.so/features/ai-workforce",
    },
    openGraph: {
        title: "AI Workforce - Deploy Multiple AI Employees as a Team | Trooper",
        description:
                                ...
                                <div className="max-w-screen-xl px-4 mx-auto sm:px-6 mb-4">
                                    <div className="text-center px-4 sm:px-6 lg:px-8">
                                        ...
                                        <p className="max-w-md mx-auto mt-3 text-base text-slate-500 sm:mb-0 sm:text-lg md:mt-5 md:text-lg md:max-w-2xl">
                                            Stop relying on single-purpose AI tools. Trooper lets you deploy entire AI organizations where multiple AI employees collaborate, share context, and execute tasks across GitHub, email, browsers, and your full tech stack.
                                        </p>
                    ...
                    <div className="max-w-3xl">
                        ...
                        <div className="prose prose-slate prose-lg">
                            <p className="text-slate-600 mb-4">
                                Traditional AI assistants handle one task at a time. When the job gets complex, they fall short. Trooper takes a fundamentally different approach by letting you create AI organizations made up of multiple AI employees, each with their own roles, skills, and system access.
                            </p>
                            <p className="text-slate-600 mb-4">
