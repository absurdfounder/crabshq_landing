      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid gap-8 items-start mb-16">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-tr from-emerald-100 to-emerald-100 rounded-2xl transform rotate-1 scale-105 opacity-30 -z-10"></div>
        ...
        <div className="grid gap-8 mb-16">
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-slate-200 hover:shadow-md transition duration-300">
            <h2 className="text-xl font-bold text-slate-900 mb-4 flex items-center">
              <span className="bg-emerald-100 text-emerald-700 w-8 h-8 rounded-md flex items-center justify-center text-sm mr-3">1</span>
              About
            </h2>
          ...
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-slate-200 hover:shadow-md transition duration-300">
            <h2 className="text-xl font-bold text-slate-900 mb-4 flex items-center">
              <span className="bg-emerald-100 text-emerald-700 w-8 h-8 rounded-md flex items-center justify-center text-sm mr-3">2</span>
              Features
            </h2>
            ...
            {relatedTemplates.map((template, index) => (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col">
                  <div className="mb-3">
                    <span className="bg-emerald-50 text-emerald-600 text-xs font-medium px-2.5 py-1 rounded-md">
                      {template.product.type}
                    </span>
                  </div>

                  <h3 className="font-bold text-slate-800 group-hover:text-emerald-600 transition-colors text-lg mb-2">
