...
function TemplateClientContent() {
        ...
        for (let i = 0; i < filteredTemplatesList.length; i++) {
                                    ...
                                    <div className="relative flex flex-col lg:flex-row justify-between items-center py-6">
                                        ...
                                        <div className="text-center lg:text-left lg:max-w-xl space-y-6">
                                            <h3 className="h3 text-white mb-2">
                                                Planning to <b className="text-emerald-600">migrate</b> to
                                            ...
                                            <div className="w-full lg:w-auto">
                                                <div onClick={(e) => e.preventDefault()} className="inline-block"> {/* Prevent nested link navigation */}
                                                    <FlippingButtonLink
                                                        ...
                                                        className="btn bg-emerald-700 hover:bg-emerald-700 shadow px-12 inline-block text-slate-900 py-3" // Original classes merged with base
                                                    />
                                                </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="relative flex flex-col lg:flex-row justify-between items-center py-6">
                                        ...
                                        <div className="text-center lg:text-left lg:max-w-xl space-y-6">
                                            <h3 className="h3 text-white mb-2">
                                                Want to get <b className="text-emerald-600">free design</b> assistance?
                                            </h3>
                                            ...
                                            <div className="w-full lg:w-auto">
                                                 <div onClick={(e) => e.preventDefault()} className="inline-block"> {/* Prevent nested link navigation */}
                                                    <FlippingButtonLink
                                                        ...
                                                        className="btn bg-white hover:bg-slate-100 shadow px-12 inline-block text-emerald-600 py-3" // Original classes merged with base
                                                    />
                                                 </div>
            ...
            items.push(
                <Link
                    ...
                    key={`template-${i}`}
                    className="group relative flex flex-col overflow-hidden bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 h-full border border-slate-200 hover:border-emerald-200"
                >
                    <div className="w-full">
                        ...
                        <div className="p-6">
                            ...
                            <span className="inline-flex items-center px-3 py-1 rounded-md text-xs font-medium bg-emerald-100 text-emerald-700">
                            ...
                            <div className="mt-4 flex items-start">
                                ...
                                <span className="ml-2 text-slate-400 group-hover:text-emerald-500 transition-colors duration-200">
                                    <svg
                                        width="14"
                                        height="14"
                                        viewBox="0 0 12 11"
    ...
    return (
        <section id="template-section">
            ...
            <div className="site-header-clear max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="pt-4 pb-12 md:pt-12 md:pb-18">
                    <div className="mx-auto text-center">
                        <h1 className="font-funneldisplay text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl md:text-4xl mb-6">
                            ...
                            <span className="block text-emerald-600">and a few templates.</span>
                        </h1>
                            ...
                            <div className="mb-4 max-w-4xl m-auto">
                                ...
                                {lesserTags.length > 0 && (
                                    <button
                                        ...
                                        className="mt-4 text-sm text-emerald-600 hover:text-emerald-700 font-medium transition-colors duration-200"
                                    >
                    ...
                    {isLoading ? (
                        <div className="flex justify-center items-center py-20">
                            <div className="animate-spin rounded-md h-12 w-12 border-b-2 border-emerald-500"></div>
                        </div>
                    ) : (
                        <>
                            {/* Empty state */}
