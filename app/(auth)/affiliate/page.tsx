...
refer to Trooper, without limits. Join
        our affiliate program today and start earning money.
          ...
          <div className="m-auto text-center"><Link className="btn text-dark text-2xl bg-red-300 hover:bg-red-700 hover:text-red-100 w-full mb-4 sm:w-auto sm:mb-0 flex items-center justify-center" href="https://trooper.lemonsqueezy.com/affiliates">Sign Up</Link></div>
          <Link href="https://trooper.lemonsqueezy.com/affiliates" target="_blank" rel="noopener"  className="block mt-8 text-sm text-red-600 sm:mt-4 m-auto w-fit">Already partner? Open the affiliate dashboard →</Link>
          ...
          <div className="max-w-sm mx-auto items-start md:max-w-2xl lg:max-w-none mt-20">
            ...
            <div className="py-12">
              ...
              <div className="mt-8 text-center">
                <Link href="https://trooper.lemonsqueezy.com/affiliates" target="_self" className="btn text-dark text-2xl bg-red-300 hover:bg-red-700 hover:text-red-100 w-full mb-4 sm:w-auto sm:mb-0 flex items-center justify-center">Become our Partner</Link>
              </div>
            </div>
          ...
          <div className="pt-12 pb-16 relative z-10 bg-white">
            ...
            <div className="max-w-7xl  container mx-auto">
              ...
              <div className="text-center mt-8">
                <Link href="https://partner.trooper.so/" target="_self" className="btn text-dark text-2xl bg-red-300 hover:bg-red-700 hover:text-red-100 w-full mb-4 sm:w-auto sm:mb-0 flex items-center justify-center">Start to earn money</Link>
              </div>
            </div>
          </div>
