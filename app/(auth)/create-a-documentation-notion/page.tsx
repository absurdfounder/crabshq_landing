...
export const metadata = {
    ...
    description:
        "Build a documentation in Notion, with our Notion documentation maker. Go live in under a minute.  Build your free CrabsHQ  documentation website in a minute!",
    alternates: {
                                ...
                                <div className="max-w-screen-xl px-4 mx-auto sm:px-6 mb-4">
                                    <div className="text-center px-4 sm:px-6 lg:px-8">
                                        <h1 className="font-funneldisplay text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-slate-900 leading-tighter tracking-tighter mb-4 aos-init aos-animate">
                                            ...
                                            <br className="block" />
                                             <span className="text-3xl sm:text-4xl md:text-5xl gradient-text-accent mx-4">documentation</span>  up-to-date.
                                        </h1>
