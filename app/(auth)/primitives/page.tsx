...
export default function PrimitivesPage() {
  return (
    <div className="min-h-screen bg-canvas text-ink">
      <Header />
      <section className="site-header-clear border-b border-[var(--color-line)]">
        <div className="mx-auto max-w-7xl border-x-0 border-[var(--color-line)] px-5 py-12 md:border-x md:px-10 md:py-16">
          <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-fern-700">Trooper primitives · {primitives.length} capabilities</span>
          <h1 className="mt-5 max-w-5xl font-funneldisplay text-4xl leading-[1.02] tracking-[-0.04em] text-ink sm:text-5xl md:text-7xl">
