...
export default function PrivacyPolicyPage() { // Renamed component for clarity
  return (
    <SectionShell eyebrow="PRIVACY POLICY" eyebrowNumber="01" bgClass="bg-white">
          ...
          <div className="prose prose-lg max-w-none"> {/* Using Tailwind Typography for basic styling */}
            ...
            <div className="mb-8 p-4 border rounded bg-gray-50">
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li><a href="#personal-information-we-collect" className="text-emerald-600 hover:underline">Personal Information We Collect</a></li>
                <li><a href="#how-do-we-use-your-personal-information" className="text-emerald-600 hover:underline">How Do We Use Your Personal Information?</a></li>
                <li><a href="#sharing-your-personal-information" className="text-emerald-600 hover:underline">Sharing Your Personal Information</a></li>
                <li><a href="#anonymous-performance-data-collection" className="text-emerald-600 hover:underline">Anonymous Performance Data Collection</a></li>
                <li><a href="#behavioral-advertising" className="text-emerald-600 hover:underline">Behavioral Advertising</a></li>
                <li><a href="#do-not-track" className="text-emerald-600 hover:underline">Do Not Track</a></li>
                <li><a href="#lawful-basis" className="text-emerald-600 hover:underline">Lawful Basis (for EEA Residents)</a></li>
                <li>
                  <a href="#your-rights" className="text-emerald-600 hover:underline">Your Rights</a>
                  <ul className="list-disc list-inside ml-5 mt-1 space-y-1">
                    <li><a href="#gdpr" className="text-emerald-600 hover:underline">GDPR (EEA Residents)</a></li>
                    <li><a href="#ccpa" className="text-emerald-600 hover:underline">CCPA (California Residents)</a></li>
                    <li><a href="#cookies" className="text-emerald-600 hover:underline">Cookies</a></li>
                  </ul>
                </li>
                <li><a href="#data-retention" className="text-emerald-600 hover:underline">Data Retention</a></li>
                <li><a href="#changes" className="text-emerald-600 hover:underline">Changes</a></li>
                <li><a href="#contact-us" className="text-emerald-600 hover:underline">Contact Us</a></li>
              </ul>
            </div>
            ...
            <ul className="list-disc list-inside space-y-1 mb-4">
                <li><strong>“Cookies”</strong>: Data files placed on your device, often including an anonymous unique identifier. Learn more at <a href="http://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:underline">allaboutcookies.org</a>.</li>
            ...
            <ul className="list-disc list-inside space-y-1 mb-4">
                <li><strong>Facebook:</strong> <a href="https://www.facebook.com/settings/?tab=ads" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:underline">https://www.facebook.com/settings/?tab=ads</a></li>
                <li><strong>Google:</strong> <a href="https://www.google.com/settings/ads/anonymous" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:underline">https://www.google.com/settings/ads/anonymous</a></li>
                <li><strong>Twitter:</strong> <a href="https://twitter.com/settings/your_twitter_data/audiences" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:underline">https://twitter.com/settings/your_twitter_data/audiences</a> (Link may vary, check Twitter settings)</li>
            </ul>
            <p>Additionally, you can opt out of some services via the Digital Advertising Alliance’s portal: <a href="http://optout.aboutads.info/" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:underline">http://optout.aboutads.info/</a>.</p>
