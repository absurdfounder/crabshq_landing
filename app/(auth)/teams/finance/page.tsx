                                ...
                                <div className="max-w-screen-xl px-4 mx-auto sm:px-6 mb-4">
                                    <div className="text-center px-4 sm:px-6 lg:px-8">
                                        <h1 className="font-funneldisplay text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-slate-900 leading-tighter tracking-tighter mb-4 aos-init aos-animate">
                                            ...
                                            <br className="block" />
                                            <span className="text-3xl sm:text-4xl md:text-5xl gradient-text-accent mx-4">managing your finances</span>
                                        </h1>
                                        <p className="max-w-md mx-auto mt-3 text-base text-slate-500 sm:mb-0 sm:text-lg md:mt-5 md:text-lg md:max-w-2xl">
                                            Deploy an entire AI finance team that handles bookkeeping, financial reporting, forecasting, budgeting, and expense management. Make data-driven financial decisions with confidence.
                                        </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl">
                        <h2 className="font-funneldisplay text-2xl sm:text-3xl font-bold text-slate-900 mb-6">
                            Why AI finance teams provide better financial insights
                        </h2>
                        <div className="prose prose-slate prose-lg">
                            ...
                            <p className="text-slate-600 mb-4">
                                Deploy specialized AI employees for accounts payable, accounts receivable, financial analysis, budgeting, tax preparation, and investor reporting. Each works autonomously while collaborating to maintain financial health.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-12 grid md:grid-cols-3 gap-8">
                        <div className="p-6 rounded-lg border border-neutral-200">
                            <h3 className="font-semibold text-slate-900 mb-2">Automated Bookkeeping</h3>
                            <p className="text-sm text-slate-600">Process transactions, reconcile accounts, categorize expenses, and maintain accurate financial records automatically.</p>
                        </div>
                        <div className="p-6 rounded-lg border border-neutral-200">
                            <h3 className="font-semibold text-slate-900 mb-2">Financial Analysis</h3>
                            <p className="text-sm text-slate-600">Generate reports, analyze trends, forecast cash flow, and provide actionable insights for strategic decision-making.</p>
                        </div>
                        <div className="p-6 rounded-lg border border-neutral-200">
                            <h3 className="font-semibold text-slate-900 mb-2">Budget Management</h3>
                            <p className="text-sm text-slate-600">Track spending, manage budgets, flag overages, and optimize resource allocation across departments.</p>
                        </div>
                    </div>
                </div>
            </section>
