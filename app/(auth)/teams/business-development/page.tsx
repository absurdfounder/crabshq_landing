...
export const metadata = {
    title: "AI Business Development Team - Partnership & Growth | Trooper",
    description:
        "Deploy an AI-powered business development team with Trooper. Automate partnership outreach, deal sourcing, relationship management, and strategic growth initiatives.",
    alternates: {
        canonical: "https://trooper.so/teams/business-development",
    },
    openGraph: {
        title: "AI Business Development Team - Partnership & Growth | Trooper",
        description:
            "Deploy an AI-powered business development team with Trooper. Automate partnership outreach and relationship management.",
        images: [
            {
    ...
    twitter: {
        ...
        title: "AI Business Development Team - Partnership & Growth | Trooper",
        description:
            "Deploy an AI-powered business development team with Trooper. Automate partnership outreach and growth.",
        images: [
            {
                url: "https://dazzling-cat.netlify.app/trooper_social.png",
                alt: "AI Business Development Team - Partnership & Growth",
                    ...
                    <div className="max-w-3xl">
                        ...
                        <div className="prose prose-slate prose-lg">
                            <p className="text-slate-600 mb-4">
                                Traditional business development is relationship-driven and difficult to scale. Trooper's AI business development team operates continuously, identifying opportunities, reaching out to partners, and nurturing relationships across time zones.
                            </p>
                            <p className="text-slate-600 mb-4">
