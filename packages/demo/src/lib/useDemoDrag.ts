...
import type { DemoKanbanTask } from '../scenarios/types';
import { DRAG, cursorTravelMs } from './demoMotion';
import { pointInCanvas, rectInCanvas, type CanvasPoint } from './demoGeometry';
